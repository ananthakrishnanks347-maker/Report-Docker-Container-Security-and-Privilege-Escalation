...
📄 **Full writeup continues in:**
- [`01-Initial-Access.md`](./01-Initial-Access.md) *(if applicable — update link to match your repo's actual filenames)*
- [`03-Post-Exploitation-and-Remediation.md`](./03-Post-Exploitation-and-Remediation.md)
